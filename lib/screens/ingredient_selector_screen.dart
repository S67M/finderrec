...
class _IngredientSelectorScreenState extends State<IngredientSelectorScreen> {
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: state != IngredientState.none
              ? [BoxShadow(color: borderColor.withOpacity(0.25), blurRadius: 6, offset: const Offset(0, 3))]
  ...
  Widget build(BuildContext context) {
    ...
    // appear in real time as soon as they are saved to Firestore.
    return StreamBuilder<List<Map<String, String>>>(
      stream: DBService().getCustomIngredients(),
      builder: (context, snapshot) {
        final customList         = snapshot.data ?? [];
        final mergedCategories   = mergeIngredients(kBaseIngredients, customList);
        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: [
              ...
              if (_showInfoBanner)
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: const Color(0xFFF4631E).withOpacity(0.40),
                    ),
                  ),
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: const Icon(Icons.close_rounded, size: 18, color: Color(0xFFF4631E)),
                      ),
                    ],
                  ),
                ),
              ...
              // ── Ingredient categories (merged base + custom) ───────────────
              ...mergedCategories.entries.map((category) {
                return Padding(
